...
public class MyLinkedList<E>  {
  ...
  {
    MyLinkedList<Integer> gemaalde = new MyLinkedList<>();
    Node<E> hoofElement = head;

    while (hoofElement != null) 
	{
        if (hoofElement.element instanceof Integer) 
		{  
            int antwoord = TimesFive((Integer) hoofElement.element);
            gemaalde.append(antwoord);
        }
        hoofElement = hoofElement.next;
    }
